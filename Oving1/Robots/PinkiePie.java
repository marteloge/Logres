...
public class PinkiePie extends AdvancedRobot {

// Kilde for wall avoidence: http://www.ibm.com/developerworks/library/j-fwa/index.html
// All kode som er kommentert på engelsk kommer fra linken ovenfor.
   
    private static final double DOUBLE_PI = (Math.PI * 2);
    private static final double HALF_PI = (Math.PI / 2);
	public Random generator = new Random(45);
...
// Velger å fyre av etter hvor langt borte den andre roboten er.	
