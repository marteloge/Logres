...
public class Board {
	...
	public Board(int numberOfCheckers) {
		if(numberOfCheckers % 2 != 0) {//Må være et partall
			throw new IllegalArgumentException("Antallet Checkers må være partall!");
		}
	...
	*/
	...
	public static void main(String[] args) {
		...
		LinearCheckersPuzzleNode solution = (LinearCheckersPuzzleNode) AStar.aStar(root);
		if(solution == null) {
